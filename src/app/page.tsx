    ...
    <div className="min-h-screen bg-[#F8F4ED]">
          ...
          <div className="flex items-center gap-3">
            {status === "authenticated" && session ? (
              ...
              <button
                ...
                className="flex items-center gap-2 border border-gray-300 bg-white px-3 py-1.5 text-xs font-mono text-gray-700 hover:border-gray-900 hover:text-gray-900 transition-colors whitespace-nowrap"
              >
      ...
      <main className="max-w-2xl mx-auto px-6">
        ...
        <div className="pt-16 pb-12 text-center">
          ...
          <h1 className="font-display text-5xl sm:text-6xl md:text-7xl font-black leading-[1.0] tracking-tight text-[#111111] mb-8">
          ...
          {status === "authenticated" && session?.githubUsername && (
            <div className="mb-6 border border-orange-200 bg-orange-50 p-4 text-center">
              ...
              <button
                ...
                disabled={loading}
                className="bg-gray-900 text-white px-6 py-3 text-sm font-bold tracking-widest uppercase hover:bg-gray-700 transition-colors disabled:opacity-50 w-full sm:w-auto"
              >
                {loading ? "LOADING..." : "ROAST MY FULL PROFILE →"}
              </button>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="mb-4">
            <div className="flex flex-col sm:flex-row border border-gray-900 bg-white">
              <input
                type="text"
                value={username}
                onChange={(e) => setUsername(e.target.value)}
                placeholder="github.com/username"
                className="flex-1 px-4 py-3.5 bg-transparent text-gray-900 placeholder-gray-400 text-base outline-none font-mono min-w-0"
                disabled={loading}
              />
              <button
                type="submit"
                disabled={loading || !username.trim()}
                className="bg-gray-900 text-white px-6 py-3.5 text-sm font-bold tracking-widest uppercase hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors whitespace-nowrap border-t border-gray-900 sm:border-t-0"
              >
      ...
      <footer className="border-t border-gray-200 py-6 text-center space-y-2">
